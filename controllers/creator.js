...
module.exports = {
    ...
    profileUpload: async (req, res) => {
        ...
        // findoneandupdate bc the photo is getting pushed into an existing array, a new one isnt being made each time.
            ...
            console.log("profileUpload failed", err);
    ...
    getProfile: async (req, res) => {
        try {
            ...
            const creator = await Creator.findById(req.params.id)
                .populate("likedBy").populate("eventsAttending").lean();
        ...
        getAllCreators:async (req, res) => {
            try {
                const creators = await Creator.find().populate("user").sort({ createdAt: -1 }).lean();
