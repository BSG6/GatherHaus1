...
module.exports = {
    ...
    getOnboarding: async (req, res) => {
            ...
            res.render("creator/onboarding.ejs", {user: req.user });
            } catch (err) {
            console.log(err);
            }
        },
    ...
    createProfile: async (req, res) => {
        try {
            ...
            console.log(err);
            res.redirect("/creator/onboarding");
        }
    ...
    getEditProfile: async (req, res) => {
        try {
            ...
            res.render("creator/edit", { creator: creator, user: req.user });
        } catch (err) {
        console.log(err);
        res.direct("/creator/onboarding")
        }
    },
